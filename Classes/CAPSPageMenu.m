...
- (void)initValues
{
    ...
    _selectionIndicatorColor      = [Colors whiteColor];
    _selectedMenuItemLabelColor   = [Colors whiteColor];
    _unselectedMenuItemLabelColor = [UIColor lightGrayColor];
    _scrollMenuBackgroundColor    = [Colors whiteColor];
    _viewBackgroundColor          = [Colors whiteColor];
    _bottomMenuHairlineColor      = [Colors whiteColor];
