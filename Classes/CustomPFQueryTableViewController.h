 ...
 */
@interface CustomPFQueryTableViewController : UITableViewController <UITableViewDataSource, UITableViewDelegate>

///--------------------------------------
/// @name Creating a CustomPFQueryTableViewController
///--------------------------------------
...
/**
 ...
 @return An initialized `CustomPFQueryTableViewController` object or `nil` if the object couldn't be created.
 */
...
/**
 Whether the table should load objects from start
 */
@property (nonatomic, assign, getter=shouldLoad) IBInspectable BOOL loadFromStart;
...
/**
 Whether the table should display new data from the server.
 */
@property (nonatomic, assign, getter=shouldDisplay) BOOL displayResult;
