...
@interface CustomPFQueryTableViewController () {
...
@implementation CustomPFQueryTableViewController
...
- (PFQuery *)queryForTable {
    if (!self.parseClassName) {
        [NSException raise:NSInternalInconsistencyException
                    format:@"You need to specify a parseClassName for the CustomPFQueryTableViewController.", nil];
    }
