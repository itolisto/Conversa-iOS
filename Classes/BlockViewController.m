...
- (void)yapDatabaseModified:(NSNotification *)notification
{
    ...
    [[self.databaseConnection ext:BlockedDatabaseViewExtensionName] getSectionChanges:nil
    ...
    for (YapDatabaseViewRowChange *rowChange in rowChanges)
    {
        switch (rowChange.type)
        {
            ...
            {
                if ([self.tableView numberOfRowsInSection:rowChange.originalSection] == 1) {
                    [self.tableView deleteSections:[[NSIndexSet alloc] initWithIndex:rowChange.originalSection] withRowAnimation:UITableViewRowAnimationAutomatic];
                } else {
